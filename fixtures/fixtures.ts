...
import DepositHistoryPage from "../pages/depositHistory.page";
dotenv.config();

interface Page {
  context: BrowserContext;
  searchPage: SearchPage;
  depositHistoryPage: DepositHistoryPage;
}
...
export const test = base.extend<Page>({
  ...
  depositHistoryPage: async ({ page }, use) => {
    await use(new DepositHistoryPage(page));
  },
});
